...
{
    [TestFixture]
	public class UpdateMenuMealProviderTest
	{
        ...
        [Test]
        public void UpdateMenuDatePositiveMealProviderTest()
        {
        ...
        [Test]
        public void UpdateMenuMealPositiveMealProviderTest()
        {
        ...
        [Test]
        public void UpdateMenuWithoutDateNegativeMealProviderTest(
            string parameter,
            string value,
            string message)
        {
        ...
        [Test]
        public void UpdateMenuWithoutMealNegativeMealProviderTest()
        {
        ...
        [Test]
        public void UpdateMenuWithInvalidDateNegativeMealProviderTest()
        {
        ...
        [Test]
        public void UpdateMenuWithInvalidMealIdNegativeMealProviderTest()
        {
            _menu.meal_ids[0] = 0;
            Exception ex = Assert.Throws<Exception>(() =>
                    ClientProxy.Menu.UpdateMenuById(_menuId, _menu, role));
        ...
        [Test]
        public void UpdateMenuWithUnexistedMealIdNegativeMealProviderTest()
        {
