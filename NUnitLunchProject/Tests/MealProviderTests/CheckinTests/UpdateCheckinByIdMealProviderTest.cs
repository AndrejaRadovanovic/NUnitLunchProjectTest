...
{
    [TestFixture]
	public class UpdateCheckinByIdMealProviderTest
	{
        ...
        [TestCase("answer", "yes")]
        [TestCase("answer", "no")]
        public void UpdateCheckinByIdHappyPathMealProviderTest(
           string parameter,
           string value
           )
        {
        ...
        public void UpdateCheckinByIdNegativeMealProviderTest(
            string parameter,
            string value,
            string message
            )
        ...
        [Test]
        public void UpdateMealProviderCheckinByAdminTest()
        {
        ...
        [Test]
        public void UpdateMealProviderCheckinByUserTest()
        {
            _updateCheckinDto.answer = "no";
            role = Role.User;
            Exception ex = Assert.Throws<Exception>(() =>
