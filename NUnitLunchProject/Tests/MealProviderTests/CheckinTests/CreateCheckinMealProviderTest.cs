...
namespace NUnitLunchProject.Tests.MealProviderTest.CheckinTests
{
    [TestFixture]
    public class CreateCheckinMealProviderTest
    {
        ...
        [TestCase("answer", "yes")]
        [TestCase("answer", "no")]
        public void CreateCheckinHappyPathMealProviderTest(
            string parameter,
            string value
            )
        {
        ...
        public void CreateCheckinNegativeMealProviderTests(
            string parameter,
            string value,
            string message
            )
        ...
        [Test]
        public void CreateCheckInDoubleSameDateMealProvider()
        {
            CheckinResponseDto response = ClientProxy.Checkins.CreateCheckin(_checkin, role);
            _checkinId = response.data.id;
            Exception ex = Assert.Throws<Exception>(() =>
