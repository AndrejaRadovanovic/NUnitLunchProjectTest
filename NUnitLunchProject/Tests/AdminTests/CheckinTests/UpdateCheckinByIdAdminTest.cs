...
{
    [TestFixture]
	public class UpdateCheckinByIdAdminTest
	{
        ...
        [TestCase("answer", "yes")]
        [TestCase("answer", "no")]
        public void UpdateCheckinByIdHappyPathAdminTest(
            string parameter,
            string value
            )
        {
        ...
        public void UpdateCheckinByIdNegativeAdminTest(
            string parameter,
            string value,
            string message
            )
        ...
        [Test]
        public void UpdateAdminCheckinByMealProviderTest()
        {
        ...
        [Test]
        public void UpdateAdminCheckinByUserTest()
        {
            _updateCheckinDto.answer = "no";
            role = Role.MealProvider;
            Exception ex = Assert.Throws<Exception>(() =>
